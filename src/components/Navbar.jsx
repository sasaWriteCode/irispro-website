    ...
    <nav className={`navbar${mobileOpen ? ' navbar--mobile-open' : ''}${scrolled ? ' navbar--scrolled' : ''}`} aria-label="Main navigation">
      ...
      <ul className={`navbar__links${mobileOpen ? ' navbar__links--open' : ''}`}>
          ...
          <ul className="navbar__dropdown-menu">
            <li>
              <a
                ...
                onClick={() => {
                  handleLinkClick();
                  window.dispatchEvent(new CustomEvent('open-project', { detail: { projectIndex: 0 } }));
                }}
              >
                Residential
              </a>
            ...
            <li>
              <a
                ...
                onClick={() => {
                  handleLinkClick();
                  window.dispatchEvent(new CustomEvent('open-project', { detail: { projectIndex: 1 } }));
                }}
              >
                Commercial
              </a>
            ...
            <li>
              <a
                ...
                onClick={() => {
                  handleLinkClick();
                  window.dispatchEvent(new CustomEvent('open-project', { detail: { projectIndex: 2 } }));
                }}
              >
                Automotive
              </a>
        ...
        <li className="navbar__dropdown">
          ...
          <ul className="navbar__dropdown-menu">
            <li><a href="#franchise" className="navbar__dropdown-item" onClick={handleLinkClick}>Franchise</a></li>
            <li><a href="#dealer" className="navbar__dropdown-item" onClick={handleLinkClick}>Dealership</a></li>
          </ul>
        </li>
        <li>
