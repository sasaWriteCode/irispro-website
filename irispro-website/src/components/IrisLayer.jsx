    ...
    <section ref={sectionRef} className="iris-layer" id="iris-layer" aria-label="Iris protective film layer">
      <div className="iris-layer__sticky">
        ...
        <div className="iris-layer__before">
          <img src="/images/problem-heat.png" alt="Harsh unprotected sunlight through glass" loading="lazy" />
        </div>
        {/* After (protected) */}
        <div className="iris-layer__after">
          <img src="/images/iris-comfort.png" alt="Comfortable interior with Iris film protection" loading="lazy" />
        </div>
        {/* Film line */}
